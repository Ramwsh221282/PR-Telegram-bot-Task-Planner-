...
public sealed class TestUserOtherChatRegistrationFacade : IClassFixture<DefaultTestsFixture>
{
    private readonly DefaultTestsFixture _fixture;

    public TestUserOtherChatRegistrationFacade(DefaultTestsFixture fixture) => _fixture = fixture;
